...
>
  ...
  arrowUp: `
<svg class="arrow-up" xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
  <path
  ...
  defaultImage: `
    <svg fill="currentColor" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 228.804 228.804" xml:space="preserve">
<g>
